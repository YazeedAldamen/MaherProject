...
namespace AdminDashboard.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<DataLayer.Entities.AspNetUser> _signInManager;
        private readonly UserManager<DataLayer.Entities.AspNetUser> _userManager;
        ...
        private DataLayer.Entities.AspNetUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<DataLayer.Entities.AspNetUser>();
            }
            catch
            {
        ...
        private IUserEmailStore<DataLayer.Entities.AspNetUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<DataLayer.Entities.AspNetUser>)_userStore;
        }
    }
}
